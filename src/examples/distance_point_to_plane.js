...
const v1 = this.cube.getV1();
const v2 = this.cube.getV2();
const v4 = this.cube.getV4();
const v6 = this.cube.getV6();
...
const v1v3Length = ube.getDistanceToPlane(distanceParams.b);
const v1v6Length = ube.getDistanceToPlane(distanceParams.c);
